...
// JDBC CONNECTION
	...
	String start_date = request.getParameter("start_day")+"-"+request.getParameter("start_month")+"-"+request.getParameter("start_year");
	String end_date = request.getParameter("end_day")+"-"+request.getParameter("end_month")+"-"+request.getParameter("end_year");
	...
	%>
	<h3>Diet observations</h3>
	<%
		// Getting all the diet observations
		Statement st2 = con.createStatement();
		ResultSet rs2 = st2.executeQuery("select o.ob_id,d.d_item,d.d_qty,o.ob_dto,o.ob_dtr from patients p,observations o,diet d where p.pid=o.pid and o.ob_id=d.ob_id and p.pid="+pid+" and o.ob_dtr between '"+start_date+"' and '"+end_date+"'");
	...
	-----------------------------------------------------------------------------------------------------------
	<br/>
	<h3>Weight Observations</h3>
	<%
		// Getting all weight observations
		st2 = con.createStatement();
		rs2 = st2.executeQuery("select o.ob_id,w.w_amt,o.ob_dto,o.ob_dtr from patients p,observations o,weight w where p.pid=o.pid and o.ob_id=w.ob_id and p.pid="+pid+" and o.ob_dtr between '"+start_date+"' and '"+end_date+"'");
		if(rs2.isBeforeFirst() == false)
			{
	 %>
	...
	<br/>
		-----------------------------------------------------------------------------------------------------------
	<br/> 
	<h3>Exercise Observations</h3>
	<%
		// Getting all exercise observations
		st2 = con.createStatement();
		rs2 = st2.executeQuery("select o.ob_id,e_kind,e_duration,o.ob_dto,o.ob_dtr from patients p,observations o,exercise e where p.pid=o.pid and o.ob_id=e.ob_id and p.pid="+pid+"  and o.ob_dtr between '"+start_date+"' and '"+end_date+"'");
		if(rs2.isBeforeFirst() == false)
			{
	 %>
	...
	<br/> 
	<h3>Mood Observations</h3>
	<%
		// Getting all mood observations
		st2 = con.createStatement();
		rs2 = st2.executeQuery("select o.ob_id,m.m_value,o.ob_dto,o.ob_dtr from patients p,observations o,mood m where p.pid=o.pid and o.ob_id=m.ob_id and p.pid="+pid+" and o.ob_dtr between '"+start_date+"' and '"+end_date+"'");
		if(rs2.isBeforeFirst() == false)
			{
	 %>
	...
	<%
		...
		else
		{
			...
			for(int gen_ite=0;gen_ite<gen;gen_ite++)
			{
				...
				// retrieve table
				%> 
				<h3><%=gen_ob_type_name %> observations</h3>
				<%
	 	 
	 	  
	 	 		Statement st_gen2 = con.createStatement(); 
	 	 		ResultSet rs_gen2 = st_gen2.executeQuery("select o.ob_id,t."+gen_table_att_name+",o.ob_dto,o.ob_dtr from patients p,observations o,"+gen_ob_type_name+"_type t where p.pid=o.pid and o.ob_id=t.ob_id and p.pid="+pid+" and o.ob_dtr between '"+start_date+"' and '"+end_date+"'");
	 			if(rs_gen2.isBeforeFirst() == false)
	 			{%>
	 				Sorry no observations have been found !
	...
	<%
		// Getting all mood observations
		st2 = con.createStatement();
		rs2 = st2.executeQuery("select o.ob_id,t.t_amt,o.ob_dto,o.ob_dtr from patients p,observations o,temperature t where p.pid=o.pid and o.ob_id=t.ob_id and p.pid="+pid+" and o.ob_dtr between '"+start_date+"' and '"+end_date+"'");
		if(rs2.isBeforeFirst() == false)
			{
	 			%>
	...
	-----------------------------------------------------------------------------------------------------------
		...
		else
		{
			...
			for(int a=0;a<k;a++)
			{
				...
				// retrieve table
				%> 
				<h3><%=hiv_ob_type_name %> observations </h3>
				<%
	 	 
	 	  
	 	 		st3 = con.createStatement(); 
	 	 		rs3 = st3.executeQuery("select o.ob_id,t."+table_att_name+",o.ob_dto,o.ob_dtr from patients p,observations o,"+hiv_ob_type_name+"_type t where p.pid=o.pid and o.ob_id=t.ob_id and p.pid="+pid+" and o.ob_dtr between '"+start_date+"' and '"+end_date+"'");
	 			if(rs3.isBeforeFirst() == false)
	 			{
	...
	<h3>Blood Pressure Observations</h3>
	<%
		// Getting all mood observations
		st2 = con.createStatement();
		rs2 = st2.executeQuery("select o.ob_id,b.bp_sys,b.bp_dia,o.ob_dto,o.ob_dtr from patients p,observations o,bloodpressure b where p.pid=o.pid and o.ob_id=b.ob_id and p.pid="+pid+" and o.ob_dtr between '"+start_date+"' and '"+end_date+"'");
		if(rs2.isBeforeFirst() == false)
			{
	 			%>
	...
	-----------------------------------------------------------------------------------------------------------
		...
		else
		{
			...
			for(int c=0;c<b;c++)
			{
				...
				// retrieve table
				%> 
				<h3><%=obe_ob_type_name %> observations</h3>
				<%
	 	 
	 	  
	 	 		st4 = con.createStatement(); 
	 	 		rs4 = st4.executeQuery("select o.ob_id,t."+table_att_name+",o.ob_dto,o.ob_dtr from patients p,observations o,"+obe_ob_type_name+"_type t where p.pid=o.pid and o.ob_id=t.ob_id and p.pid="+pid+" and o.ob_dtr between '"+start_date+"' and '"+end_date+"'");
	 			if(rs4.isBeforeFirst() == false)
	 			{
	...
	<h3>Pain Observations </h3>
	<%
		// Getting all mood observations
		st2 = con.createStatement();
		rs2 = st2.executeQuery("select o.ob_id,p.pain_scale,o.ob_dto,o.ob_dtr from patients p,observations o,pain p where p.pid=o.pid and o.ob_id=p.ob_id and p.pid="+pid+" and o.ob_dtr between '"+start_date+"' and '"+end_date+"'");
		if(rs2.isBeforeFirst() == false)
			{
	 			%>
	...
	%> 
		...
		<br/>
	-----------------------------------------------------------------------------------------------------------
	<h3>Contraction Observations</h3>
	<%
		// Getting all mood observations
		st2 = con.createStatement();
		rs2 = st2.executeQuery("select o.ob_id,c.con_frequency,o.ob_dto,o.ob_dtr from patients p,observations o,contraction c where p.pid=o.pid and o.ob_id=c.ob_id and p.pid="+pid+" and o.ob_dtr between '"+start_date+"' and '"+end_date+"'");
		if(rs2.isBeforeFirst() == false)
			{
	 			%>
	...
	<%	
		...
		else
		{
			...
			for(int e=0;e<d;e++)
			{
				...
				// retrieve table
				%> 
				<h3><%=hrp_ob_type_name %> observations </h3>
				<%
	 	 
	 	  
	 	 		st5 = con.createStatement(); 
	 	 		rs5 = st5.executeQuery("select o.ob_id,t."+table_att_name+",o.ob_dto,o.ob_dtr from patients p,observations o,"+hrp_ob_type_name+"_type t where p.pid=o.pid and o.ob_id=t.ob_id and p.pid="+pid+" and o.ob_dtr between '"+start_date+"' and '"+end_date+"'");
	 			if(rs5.isBeforeFirst() == false)
	 			{
	...
	<%
		...
		case 4: // COPD
		%><br/>
		<h3>Exercise Tolerance Observations </h3>
	<%
		// Getting all exercise tolerance observations
		st2 = con.createStatement();
		rs2 = st2.executeQuery("select o.ob_id,e.et_numex,o.ob_dto,o.ob_dtr from patients p,observations o,exercisetolerance e where p.pid=o.pid and o.ob_id=e.ob_id and p.pid="+pid+" and o.ob_dtr between '"+start_date+"' and '"+end_date+"'");
		if(rs2.isBeforeFirst() == false)
			{
	 			%>
	...
	%> 
		...
		<br/>
	-----------------------------------------------------------------------------------------------------------
	<h3>Oxygen Saturation Observations </h3>
	<%
		// Getting all mood observations
		st2 = con.createStatement();
		rs2 = st2.executeQuery("select o.ob_id,ox.os_amt,o.ob_dto,o.ob_dtr from patients p,observations o,oxygensaturation ox where p.pid=o.pid and o.ob_id=ox.ob_id and p.pid="+pid+" and o.ob_dtr between '"+start_date+"' and '"+end_date+"'");
		if(rs2.isBeforeFirst() == false)
			{
	 			%>
	...
	<%	
		...
		else
		{
			...
			for(int g=0;g<f;g++)
			{
				...
				// retrieve table
				%> 
				<h3><%=copd_ob_type_name %> observations </h3>
				<%
	 	 
	 	  
	 	 		st6 = con.createStatement(); 
	 	 		rs6 = st6.executeQuery("select o.ob_id,t."+table_att_name+",o.ob_dto,o.ob_dtr from patients p,observations o,"+copd_ob_type_name+"_type t where p.pid=o.pid and o.ob_id=t.ob_id and p.pid="+pid+" and o.ob_dtr between '"+start_date+"' and '"+end_date+"'");
	 			if(rs6.isBeforeFirst() == false)
	 			{
