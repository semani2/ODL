...
//Adding observation into observations and contraction table
	
	float x=Float.parseFloat(request.getParameter("c_frequency"));
	...
	st1.executeUpdate("INSERT INTO observations(ot_id,pid,ob_dto,ob_dtr) VALUES(9,"+id+",'"+dt_o+"','"+dt_r+"')");
	ResultSet rs=st3.executeQuery("SELECT ob_id from observations where ob_dtr='"+dt_r+"' AND pid="+id+"");
	rs.next();
	st3.executeUpdate("INSERT INTO contraction(ot_id,con_frequency,ob_id) VALUES (9,"+x+","+rs.getInt(1)+")");
