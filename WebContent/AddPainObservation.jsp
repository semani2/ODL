...
//Adding observation into observations and pain table
	
	int x=Integer.parseInt(request.getParameter("p_amt"));
	...
	st1.executeUpdate("INSERT INTO observations(ot_id,pid,ob_dto,ob_dtr) VALUES(7,"+id+",'"+dt_o+"','"+dt_r+"')");
	ResultSet rs=st3.executeQuery("SELECT ob_id from observations where ob_dtr='"+dt_r+"' AND pid="+id+"");
	rs.next();
	st3.executeUpdate("INSERT INTO pain(ot_id,pain_scale,ob_id) VALUES (7,"+x+","+rs.getInt(1)+")");
