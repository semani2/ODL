...
<title>Add Exercise Observation</title>
</head>
<body>
...
//Adding observation into observations and bloodpressure table
	
	int sys=Integer.parseInt(request.getParameter("bp_sys"));
	int dia=Integer.parseInt(request.getParameter("bp_dia"));
	...
	st1.executeUpdate("INSERT INTO observations(ot_id,pid,ob_dto,ob_dtr) VALUES(4,"+id+",'"+dt_o+"','"+dt_r+"')");
	ResultSet rs=st3.executeQuery("SELECT ob_id from observations where ob_dtr='"+dt_r+"' AND pid="+id+"");
	rs.next();
	st3.executeUpdate("INSERT INTO bloodpressure(ot_id,bp_sys,ob_id,bp_dia) VALUES (4,"+sys+","+rs.getInt(1)+","+dia+")");
