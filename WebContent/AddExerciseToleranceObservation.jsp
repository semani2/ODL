...
//Adding observation into observations and exercise-tolerance table
	
	float x=Float.parseFloat(request.getParameter("et_num"));
	...
	st1.executeUpdate("INSERT INTO observations(ot_id,pid,ob_dto,ob_dtr) VALUES(5,"+id+",'"+dt_o+"','"+dt_r+"')");
	ResultSet rs=st3.executeQuery("SELECT ob_id from observations where ob_dtr='"+dt_r+"' AND pid="+id+"");
	rs.next();
	st3.executeUpdate("INSERT INTO exercisetolerance(ot_id,et_numex,ob_id) VALUES (5,"+x+","+rs.getInt(1)+")");
