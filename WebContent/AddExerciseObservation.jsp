...
//Adding observation into observations and exercise table
	
	String s1=request.getParameter("ex_kind");
	float x=Float.parseFloat(request.getParameter("ex_duration"));
	...
	st1.executeUpdate("INSERT INTO observations(ot_id,pid,ob_dto,ob_dtr) VALUES(3,"+id+",'"+dt_o+"','"+dt_r+"')");
	ResultSet rs=st3.executeQuery("SELECT ob_id from observations where ob_dtr='"+dt_r+"' AND pid="+id+"");
	rs.next();
	st3.executeUpdate("INSERT INTO exercise(ot_id,e_kind,ob_id,e_duration) VALUES (3,'"+s1+"',"+rs.getInt(1)+","+x+")");
