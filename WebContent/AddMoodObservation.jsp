...
//Adding observation into observations and mood table
	
	String x=request.getParameter("m_value");
	...
	st1.executeUpdate("INSERT INTO observations(ot_id,pid,ob_dto,ob_dtr) VALUES(8,"+id+",'"+dt_o+"','"+dt_r+"')");
	ResultSet rs=st3.executeQuery("SELECT ob_id from observations where ob_dtr='"+dt_r+"' AND pid="+id+"");
	rs.next();
	st3.executeUpdate("INSERT INTO mood(ot_id,m_value,ob_id) VALUES (8,'"+x+"',"+rs.getInt(1)+")");
